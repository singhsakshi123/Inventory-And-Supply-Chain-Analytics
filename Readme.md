...
- Are we maintaining healthy inventory levels or facing overstock/stockout risks?
- Which product categories and regions drive higher transportation costs?
- Where are delays happening through longer lead times?
...
- Removed blank/duplicate records to ensure accurate reporting  
- Standardized data types (dates, numeric fields, category labels)  
...
- ✅ **3 KPI Cards** (for quick performance tracking)
...
- Executive KPI cards for fast decision-making
...
- Transportation costs are not uniform across regions, indicating potential logistics optimization opportunities
- Backorders highlight fulfillment gaps that can directly impact customer experience
